            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="ultext navbar-nav">
                    <li class="nav-item mx-2">
                        <a href="/" class="nav-link text-black"><b>Beranda</b></a>
                    </li>
                    ...
                    <li class="mx-2">
                        <a href="/masuk" type="button" class="btn ms-2 text-success" style="border-radius: 30px"
                            width="350px"><b>Masuk</b></a>
                    </li>
                    <li class="mx-2">
                        <a href="/daftar" type="button" class="btn btn-outline ms-1 bg-success text-white"
                            style="border-radius: 30px"><b>Daftar</b></a>
                    </li>
                </ul>
            </div>
        </div>
